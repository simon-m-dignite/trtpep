  ...
  return (
    <div className="w-full testosterone-therapy-header flex flex-col items-center justify-end text-white pb-10 md:pb-20 gap-4 text-center px-4">
      <h1 className="text-9xl font-extrabold">
        <sup className="font-semibold text-lg relative -top-20">$</sup>99{" "}
      ...
      <p className="text-xs font-semibold">*149.99 with HCG. NO HIDDN FEES.</p>
      <p className="text-xs font-semibold">
        *Minimum purchase 2.5 month supply
      </p>
      <a href="#enrollment-form" className="bg-color text-white px-4 py-2 rounded-md font-medium">
        Enroll Now
      </a>
    </div>
  );
