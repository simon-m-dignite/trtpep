...
const WhyChooseTRT = () => {
  return (
    <section className={`w-full ${styles.paddingHorizontal} py-12 lg:py-20 bg-gray-50`}>
      <div className="w-full flex flex-col items-center justify-center gap-y-14">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 lg:gap-x-10 gap-y-6">
          <div className="w-full flex flex-col items-start gap-3 lg:w-[380px]">
            <img
              ...
              alt=""
              className="rounded-[20px] h-[300px] w-[380px] bg-contain brightness-90"
            />
          ...
          <div className="w-full flex flex-col items-center gap-3 lg:w-[380px] text-center">
            <img
