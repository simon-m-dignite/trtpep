...
const BlogsHero = () => {
  return (
    ...
    >
      ...
      <button className="font-semibold mt-4 border border-white px-6 py-3 text-sm text-white hover:bg-blue-900 hover:border-blue-900 transition-all duration-300">
        More TRT Details
      </button>
    </div>
  );
