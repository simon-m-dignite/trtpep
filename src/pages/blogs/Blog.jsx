    ...
    <div className="w-full">
      ...
      >
        <div className="w-full col-span-3 lg:col-span-2 flex flex-col items-start gap-y-6">
          <div className="w-full">
            <img
              src="https://img.freepik.com/free-photo/online-sport-fitness-instructor-recording-her-session_23-2149204391.jpg?t=st=1718402162~exp=1718405762~hmac=2b6ffcc6784c4550906f222e156861e602ce63d4d7533db7c9df9cafe8112735&w=1060"
              alt=""
